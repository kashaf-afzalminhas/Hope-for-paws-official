...
// import { FaSearch, FaUser, FaPaw } from 'react-icons/fa';
...
//   return (
//     <nav className="bg-[#F8F4ED] p-4 sm:p-6 flex flex-wrap justify-between items-center">
//       {/* Logo Section */}
//       <div className="flex items-center space-x-2 text-2xl sm:text-3xl font-bold text-[#a07855]">
//         <FaPaw className="text-3xl sm:text-4xl text-[#a07855]" />
//         <span>HopeForPaws</span>
//       </div>

//       {/* Mobile Menu Button */}
//       <button
//         onClick={toggleMobileMenu}
//         className="md:hidden text-[#a07855] text-2xl focus:outline-none"
...
//         } md:flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 lg:space-x-8 pr-0 lg:pr-20 mt-4 md:mt-0`}
//       >
...
//         </li>
//         <li className="hover:text-black text-[#a07855] font-bold">
//           <NavLink to="/clinics" onClick={closeMobileMenu}>
//             Clinics & Vets
//           </NavLink>
//         </li>
//         <li className="hover:text-black text-[#a07855] font-bold">
//           <NavLink to="/ngo" onClick={closeMobileMenu}>
//             NGO's
//           </NavLink>
//         </li>
//         <li className="hover:text-black text-[#a07855] font-bold">
//           <NavLink to="/adoptionpage" onClick={closeMobileMenu}>
//             Adoption
//           </NavLink>
//         </li>
//         <li className="hover:text-black text-[#a07855] font-bold">
//           <NavLink to="/posts" onClick={closeMobileMenu}>
//             Posts
//           </NavLink>
//         </li>
//         <li className="hover:text-black text-[#a07855] font-bold">
...
//        <div className="flex space-x-4 sm:space-x-6 items-center relative mt-4 md:mt-0">
//         {/* <FaSearch className="text-[#a07855] cursor-pointer hover:text-black" />  */}

//         {user ? (
//           <>
//             <span className="hidden sm:inline-block text-[#a07855] font-medium">{`Welcome ${user.username}`}</span>
...
//               {isHovered && (
//                 <div
//                   className="absolute right-0 mt-3 w-full sm:w-80 p-4 sm:p-6 bg-white border border-gray-300 rounded-lg shadow-lg text-center z-10"
//                   onMouseEnter={handleMouseEnter}
//                   onMouseLeave={handleMouseLeave}
//                 >
//                   <div className="flex justify-center mb-4">
//                     <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#6b493d] text-white flex items-center justify-center text-xl sm:text-3xl font-bold">
//                       {user.username ? user.username[0].toUpperCase() : <FaUser />}
//                     </div>
//                   </div>

//                   <p className="text-lg sm:text-xl font-semibold text-[#6b493d]">Hi, {user.username}!</p>

//                   <button
//                     className="mt-3 w-full py-2 text-sm font-semibold text-red-600 border border-red-600 rounded-lg hover:bg-red-50 transition duration-200"
