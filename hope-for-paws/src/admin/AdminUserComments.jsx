...
const AdminUserComments = () => {
  ...
  const fetchComments = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/admin/comments/user/${userId}`, {
  ...
  return (
    <div className="bg-white rounded-xl shadow p-6">
      <h2 className="text-2xl font-bold mb-6 text-[#4E3B31]">User&apos;s Post Comments</h2>
      {comments.length === 0 ? (
        <div className="text-center text-gray-500">No comments found for this user.</div>
      ) : (
