...
//             <span className="text-[#ff9f67]">Connect</span> With Compassion
//           </h2>
//           <p className="text-lg sm:text-xl text-[#ffd8b8]">
//             Where Loving Hearts Meet Furry Souls
//           </p>
//           <div className="flex justify-center gap-4 mt-6 text-[#ff9f67]">
...
//                 <FaHandsHelping className="text-[#ff9f67]" />
//                 Collaboration Hub
//               </h3>
...
//                   <FaPaw className="text-[#ff9f67]" />
//                   <span>📍 Based in Lahore, Serving Nationwide</span>
//                 </div>
//                 <div className="flex items-center gap-3">
//                   <FaHeart className="text-[#ff9f67]" />
...
//               <div className="bg-[#ff9f67] p-4 rounded-full shadow-lg">
...
//                 className="w-full p-3 rounded-lg bg-white border border-[#ffd8b8] focus:ring-2 focus:ring-[#ff9f67] outline-none"
//                 required
//               />
//               <input
//                 type="email"
...
//               <button
//                 type="submit"
//                 className="w-full bg-[#ff9f67] text-white py-3 rounded-lg font-semibold hover:bg-[#ff8a4d] transition-all duration-300 flex items-center justify-center gap-2"
//               >
//                 <FaPaw /> Send Message
//               </button>
//             </form>
...
//         <div className="absolute top-20 right-20 w-24 h-24 bg-[#ff9f6733] rounded-full blur-xl"></div>
//         <div className="absolute bottom-40 left-10 w-32 h-32 bg-[#ffd8b833] rounded-full blur-xl"></div>
//       </div>
//     </section>
//   );
// };
