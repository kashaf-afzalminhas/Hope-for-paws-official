                ...
                <div key={request._id} className="bg-gray-50 rounded-lg p-4 sm:p-6 border border-gray-200">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 gap-2 sm:gap-0">
                    ...
                    <div className="flex items-center gap-2 self-start sm:self-auto">
                      ...
                      {request.user && currentUserId !== request.user._id && (
                        <button
                          onClick={() => handleStartConversation(request.user._id, request.name)}
                          className="p-2 text-gray-600 hover:text-[#a07855] transition-colors rounded-full hover:bg-gray-100"
