...
module.exports = {
  ...
  NOTIFICATION_DAILY_DIGEST_HOUR: parseInt(process.env.NOTIFICATION_DAILY_DIGEST_HOUR, 10) || 8,
  NOTIFICATION_DAILY_DIGEST_MINUTE: parseInt(process.env.NOTIFICATION_DAILY_DIGEST_MINUTE, 10) || 0,
  NOTIFICATION_DIGEST_MAX_AGE_HOURS: parseInt(process.env.NOTIFICATION_DIGEST_MAX_AGE_HOURS, 10) || 24,
  NOTIFICATION_DIGEST_BATCH_SIZE: parseInt(process.env.NOTIFICATION_DIGEST_BATCH_SIZE, 10) || 50,
